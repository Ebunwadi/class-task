//A code to check if you are an adult
const age = parseInt(prompt('how old are you'));
if (age >= 18) {
  console.log("You are an adult");
}

// A code to find either positive or negative number
const num = parseInt(prompt('input a number'));
if (num > 0) {
  console.log("The number is poistve");
} else {
  console.log("The number is negative");
}

// A code to find if a fruit is apple
const fruit = prompt('input a fruit');
if (fruit === "apple") {
...
for (let i = 0; i <= info.length; i++) {
  ...
  streets.push(info[i].address.street);
}
